...
export function createIncomingInsertQuery(data) {
  ...
  return {
    ...
    values: [transactionId, type, amount, formatPostgresDateTime(timestamp), currency, sender, originalSMS]
  };
}
...
export function createReclaimedInsertQuery(data) {
  ...
  return {
    ...
    values: [transactionId, type, amount, formatPostgresDateTime(timestamp), currency, sender, senderNumber, originalSMS]
  };
}
...
export function createPaymentInsertQuery(data) {
  ...
  return {
    ...
    values: [transactionId, type, amount, formatPostgresDateTime(timestamp), currency, recipient, recipientNumber, fee, originalSMS]
  };
}
...
export function createBankDepositInsertQuery(data) {
  ...
  return {
    ...
    values: [transactionId, type, amount, formatPostgresDateTime(timestamp), currency, originalSMS]
  };
}
...
export function createWithdrawnInsertQuery(data) {
  ...
  return {
    query: `INSERT INTO withdrawn (transactionId, type, amount, timestamp, currency, agent, agentNumber, fee, originalSMS)
            VALUES ($1, $2, $3, $4, $5, $6, $7, $8, $9) RETURNING id`,
    values: [transactionId, type, amount, formatPostgresDateTime(timestamp), currency, agent, agentNumber, fee, originalSMS]
  };
}
...
export function createAirtimeBillInsertQuery(data) {
  ...
  return {
    query: `INSERT INTO airtime_bill (transactionId, type, amount, timestamp, currency, purchasedItem, originalSMS)
            VALUES ($1, $2, $3, $4, $5, $6, $7) RETURNING id`,
    values: [transactionId, type, amount, formatPostgresDateTime(timestamp), currency, purchasedItem, originalSMS]
  };
}
...
export function createUtilityBillInsertQuery(data) {
  ...
  return {
    query: `INSERT INTO utility_bill (transactionId, type, amount, timestamp, currency, purchasedUtility, meterToken, fee, originalSMS)
            VALUES ($1, $2, $3, $4, $5, $6, $7, $8, $9) RETURNING id`,
    values: [transactionId, type, amount, formatPostgresDateTime(timestamp), currency, purchasedUtility, meterToken, fee, originalSMS]
  };
}
...
export function createThirdPartyInsertQuery(data) {
  ...
  return {
    query: `INSERT INTO third_party (transactionId, type, amount, timestamp, currency, thirdParty, fee, externalTransactionId, originalSMS)
            VALUES ($1, $2, $3, $4, $5, $6, $7, $8, $9) RETURNING id`,
    values: [transactionId, type, amount, formatPostgresDateTime(timestamp), currency, thirdParty, fee, externalTransactionId, originalSMS]
  };
}